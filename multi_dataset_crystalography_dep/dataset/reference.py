...
class DefaultReferenceGetter:
        ...
        def __call__(self, datasets):
            ...
            if self.reference_pdb_path and self.reference_mtz_path:
                ...
                ref_pdb, ref_mtz = self.select_reference_dataset(datasets, method='resolution')

            # Load the reference dataset
            reference_dataset = self.load_reference_dataset(ref_pdb_path=ref_pdb, ref_mtz_path=ref_mtz)
